...
router.get('/playlists/:searchText', auth.verify, PlaylistController.searchPlaylistByName)
router.get('/playlists/users/:searchText', auth.verify, PlaylistController.searchPlaylistByUser)
